...
const SF = loadCore();
for (const mod of ['tier', 'color', 'draw', 'sheet', 'mesh', 'templates', 'project'])
...
const suites = ['./tier.test.mjs', './project.test.mjs', './color.test.mjs', './draw.test.mjs', './select.test.mjs', './frames.test.mjs', './sheet.test.mjs', './mesh.test.mjs', './templates.test.mjs', './gamemaker.test.mjs', './engines.test.mjs', './godot.test.mjs', './targets-store.test.mjs', './palettes.test.mjs', './png-decode.test.mjs', './project-ui.test.mjs', './sprites-ui.test.mjs', './targets-ui.test.mjs', './platform.test.mjs', './keybindings.test.mjs', './version.test.mjs', './sync-web.test.mjs', './kit-integrity.test.mjs'];
